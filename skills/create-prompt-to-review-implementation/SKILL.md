...
1. **Save the generated prompt** to `docs/plans/{stack}-{milestone}-prompt-phase-{N}-review.md`
   - Example: `docs/plans/frontend-p1-prompt-phase-2-review.md`
...
2. **Report to the user** with a short summary (do NOT print the prompt content on screen):
   ...
   - Output file: `docs/plans/{stack}-{milestone}-prompt-phase-{N}-review.md`
...
| `docs/plans/template-implementation-review.md` | Review report structure template |
| `docs/plans/{stack}-{milestone}-prompt-phase-{N}-review.md` | Generated review prompt output file |
